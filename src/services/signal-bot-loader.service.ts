...
class SignalBotLoaderService {
    private readonly BOT_MAPPINGS = {
        ...
        EVEN_ODD: [
            ...
            {
                file: 'Even and odd flipper📊📈.xml',
                name: 'Even and Odd Flipper',
                description: 'Advanced flipping strategy for Even/Odd trading',
                suitability: 96,
                minConfidence: 65,
            },
            {
                file: 'EVENODD Double loss Bot .xml',
                name: 'Even/Odd Double Loss Bot',
                description: 'Specialized Even/Odd bot with double loss recovery strategy',
                suitability: 95,
                minConfidence: 68,
            },
            {
        ...
        OVER_UNDER: [
            ...
            {
                file: 'Raziel Over Under.xml',
                name: 'Raziel Over Under',
                description: 'Advanced Over/Under bot with Raziel intelligence system',
                suitability: 96,
                minConfidence: 68,
            },
            {
                file: 'Unkownmentor over destroyer💲.xml',
                name: 'Unknown Mentor Over Destroyer',
                description: 'Powerful Over/Under destroyer bot with advanced strategies',
                suitability: 95,
                minConfidence: 70,
            },
            {
            ...
            {
                file: 'Over 3 Delirium.xml',
                name: 'Over 3 Delirium',
                description: 'Specialized Over 3 trading bot with delirium strategy',
                suitability: 93,
                minConfidence: 68,
            },
            {
            ...
            },
            {
                ...
                name: 'Over/Under Ghost V2 by Auto Trades',
        ...
        MULTI_STRATEGY: [
            ...
            {
                file: 'Game Changer AI .xml',
                name: 'Game Changer AI',
                description: 'AI-powered multi-strategy bot with intelligent pattern recognition',
                suitability: 94,
                minConfidence: 70,
            },
            {
                file: 'Profit Pilot.xml',
                name: 'Profit Pilot',
                description: 'Advanced profit-focused trading bot with smart navigation',
                suitability: 93,
                minConfidence: 68,
            },
            {
                file: 'Speed Auto Bot🦷.xml',
                name: 'Speed Auto Bot',
                description: 'High-speed automated trading bot for quick executions',
                suitability: 92,
                minConfidence: 65,
            },
            {
            ...
            {
                file: 'ALEXSPEEDBOT_ EXPRO2 (2).xml',
                name: 'Alex Speed Bot EXPRO2',
                description: 'Expert-level speed trading bot with advanced algorithms',
                suitability: 91,
                minConfidence: 72,
            },
            {
                ...
                description: 'Premium AI-powered automated trading robot',
                suitability: 90,
                minConfidence: 70,
            },
            {
                file: 'Flipping-Tool-2026 .xml',
                name: 'Flipping Tool 2026',
                description: 'Modern flipping strategy bot for 2026 market conditions',
                suitability: 89,
                minConfidence: 68,
            },
            {
            ...
            },
            {
                ...
                name: 'Deriv Killer by Auto Trades',
                description: 'High-performance multi-strategy bot',
                suitability: 85,
                minConfidence: 75,
            },
            {
                file: 'Atomated under 😎.xml',
                name: 'Automated Under',
                description: 'Specialized automated under trading bot',
                suitability: 84,
                minConfidence: 65,
            },
        ],
